...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Passcode', auth_plugin='mysql_native_password')
...
icon = Image.open("C:\\Projects\\Bizcard\\business_card_home.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By Sheik Abdul Kather",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by *Sheik Abdul Kather*!"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:\\Projects\\Bizcard\\business_card_home.png"), width=500)
